...
// import { getMaskedPatients, applyMasking, type MaskedPatient } from "@/api/maskingApi"
// import {
//   Table,
//   TableBody,
//   TableCell,
...
//   async function handleApplyMasking() {
//   setIsApplying(true)
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-2">
        <h1 className="text-2xl font-semibold">Masking</h1>
        <Button onClick={handleApplyMasking} disabled={isApplying}>
          {isApplying ? "Recording..." : "Record for Comparison"}
        </Button>
      </div>
      ...
      {applyMessage && (
        <p className="text-sm text-green-600 mb-4">{applyMessage}</p>
      )}
